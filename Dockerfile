...
LABEL maintainer="Kutim <1252900197@qq.com>" version="7.3.1"
...
&& curl -o ${AGENT_PATH}/${AGENT_FILENAME}  https://github.com/Kutim/confluence/releases/download/v${AGENT_VERSION}/atlassian-agent.jar -L \
